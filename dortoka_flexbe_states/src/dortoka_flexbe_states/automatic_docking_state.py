...
class AutomaticDocking(EventState):
	'''
	Calls the automatic docking service

	'''

	def __init__(self):
		# See example_state.py for basic explanations.
		super(AutomaticDocking, self).__init__(outcomes=['done', 'failed'])
	...
	def on_enter(self, userdata):
		...
		try:
			...
			Logger.logwarn('Failed to send the DOCK command:\n%s' % str(e))
			self._error = True
